  ...
  return (
    <Grid container className={classes.container}>
      <div className={classes.logotypeContainer}>
        ...
        <Typography className={classes.logotypeText}>RentSahayak</Typography>
      </div>
      <div className={classes.formContainer}>
        <div className={classes.form}>
          <Tabs
            ...
            centered
          >
            <Tab label="Admin Login" classes={{ root: classes.tab }} />
            <Tab label="Admin Register" classes={{ root: classes.tab }} />
          </Tabs>
        ...
        <Typography color="primary" className={classes.copyright}>
          RentSahayak, All rights reserved.
        </Typography>
      </div>
    </Grid>
  );
