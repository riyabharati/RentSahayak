...
const initialRegisterData={fullName:"",email:"",password:"",category:userCategory.TENANT,category2:userCategory.RENTER}
          ...
          <div className="main-div">
            ...
            <div className="form-group d-flex ">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value={registerData.category} id="flexCheckDefault"/>
              ...
              <div class="form-check ml-3" >
                <input class="form-check-input " type="checkbox" value={registerData.category2} id="flexCheckDefault"/>
                <label class="form-check-label" for="flexCheckDefault">
                  Renter
                </label>
